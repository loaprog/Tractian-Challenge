...
from src.services.predict import predict_point, get_models_for_series_service
...
@predict_router.get("/series/{series_id}/models", tags=["Series"])
def get_models_for_series(series_id: str, db: Session = Depends(get_db)):
    models = get_models_for_series_service(series_id, db)
